...
![Bracket Version 6](./images/1.png)

## An open source Bracket for the PHOB & GCC with...
 - NEW design for 3v Buck Converter
...
1. Get the bracket 
    - print the bracket and lid(s) ideally with PLA+ 
        - *OR*
    - order a set from your preferred print house

2. **_REQUIRED_** Stepping down the motor from 5v to 3v
    - **Resistor**) attach a ~25 ohm (22ohm is suffiecient) resistor to the positive lead. Do this by splicing in the resistor towards the beginning of the wire closest to the motor. Cut heat shrink to cover the spliced resistor.
    
<img src="./images/pics/install 2/1.jpeg" alt="Image" width="300" >
<img src="./images/pics/install 2/2.jpeg" alt="Image" width="300" >
<img src="./images/pics/install 2/3.jpeg" alt="Image" width="300" >
<img src="./images/pics/install 2/4.jpeg" alt="Image" width="300" >
    
 - *OR*
    - **Buck module**) trim motor's wire leads then connect the buck converter to 3v and ground wires of the motor ( I save the extra wire for the rest of the connections) If you purchased the presoldered buck converters I recommended you desolder the pins and solder the wire like you would with a GCC trigger paddle. or you could fasion a PC style connector but it might be a tight fit.

<img src="./images/pics/install/1.jpeg" alt="Image" width="300" >
<img src="./images/pics/install/2.jpeg" alt="Image" width="300" >
<img src="./images/pics/install/4.jpeg" alt="Image" width="300" >
<img src="./images/pics/install/5.jpeg" alt="Image" width="300" >
<img src="./images/pics/install/6.jpeg" alt="Image" width="300" >
<img src="./images/pics/install/7.jpeg" alt="Image" width="300" >
<img src="./images/pics/install/8.jpeg" alt="Image" width="300" >
<img src="./images/pics/install/9.jpeg" alt="Image" width="300" >


3. Final bracket assembly
     - put the motor (and Buck converter if you choose that model) in the housing
     
4. Heat insert the inserts
...
6. Final assembly
    - push in the trigger paddles, Then hook the bracket onto the top of the trigger potentiometer and pull the bottom of the bracket over the bottom of the trigger potentiometers,
